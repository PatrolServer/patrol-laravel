...
class PatrolSdkServiceProvider extends ServiceProvider {
    ...
    private function getProvider() {
        ...
        switch ($version) {
            case 4:
                return new PatrolSdkServiceProviderLaravel4($app);

            case 5:
                return new PatrolSdkServiceProviderLaravel5($app);
    ...
    public function provides() {
        return ['patrolserver.laravel-patrol'];
    }
